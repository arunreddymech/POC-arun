...
public class Imdb {
	...
	By movieYear = By.xpath(".//*[@id='main']/div/span/div/div/div[3]/table/tbody/tr/td[2]/span");
	By movieRating = By.xpath(".//*[@id='main']/div/span/div/div/div[3]/table/tbody/tr/td[3]/strong");
	...
	public List<String> getMovieNames() {
		ArrayList<WebElement> movieName = (ArrayList<WebElement>) driver
				.findElements(By.xpath("//*[@class='titleColumn'][1]/a"));
